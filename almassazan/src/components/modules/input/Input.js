...
function Input({
  ...
  return (
    <>
      <div dir="ltr"
        className={`bg-BG-400 md:bg-BG-600 rounded-lg md:rounded-2xl overflow-hidden w-full h-10 md:h-14 p-2  flex items-center gap-x-2 outline  has-[:focus]:outline-text-500 ${
