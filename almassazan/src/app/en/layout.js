      ...
      <body className="md:bg-BG-500 ">
        <>
          ...
          <div
            ...
            top-0
            sm:left-[calc((100vw-640px)/2)]
            md:left-[calc((100vw-768px)/2)] 
            lg:left-[calc((100vw-1024px)/2)] 
            xl:left-[calc((100vw-1280px)/2)] 
            2xl:left-[calc((100vw-1536px)/2)] 
...
export const metadata = {
  title: "almas sazan",
  description: "almas sazan company",
};
